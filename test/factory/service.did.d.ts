...
export interface Bid { 'offer' : Offer__2, 'owner' : Principal }
...
export interface Dip721 {
  ...
  'bulkMint' : ActorMethod<
    [Array<Uint8Array | number[]>, Principal],
    Uint32Array | number[]
  >,
  ...
  'fetchOwners' : ActorMethod<
    [Uint32Array | number[]],
    Array<{ 'owner' : Principal, 'mintId' : number }>
  >,
...
export interface Metadata { 'data' : Uint8Array | number[], 'mintId' : number }
...
export interface Price { 'offer' : Offer__1, 'timeStamp' : Time }
...
export type Token = { 'EXT' : string } |
  { 'IRC2' : string } |
  { 'Dip20' : string } |
  { 'Dip20_EXT' : string };
export type Token__1 = { 'EXT' : string } |
  { 'IRC2' : string } |
  { 'Dip20' : string } |
  { 'Dip20_EXT' : string };
